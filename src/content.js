...
export const content = {
  es: {
    ...
    showcase: {
      ...
      uiMetricLabel: 'Tu semana',
      uiMetricNote: 'De un vistazo',
      uiRows: ['Calendario', 'Diario', 'Tiempo'],
      uiStateOk: 'Activo',
      uiStateRun: 'Opcional',
    },
    capabilities: {
  ...
  en: {
    ...
    showcase: {
      ...
      uiMetricLabel: 'Your week',
      uiMetricNote: 'At a glance',
      uiRows: ['Calendar', 'Journal', 'Weather'],
      uiStateOk: 'On',
      uiStateRun: 'Optional',
    },
    capabilities: {
